    ...
    return (
        <div>
            ...
            <footer className="bg-white fixed bottom-0 left-0 w-full">
                <div className="mx-auto w-full max-w-screen-xl p-3 py-3 lg:py-3">

                    <hr className="my-3 border-default sm:mx-auto lg:my-3" />
                    <div className="sm:flex sm:items-center sm:justify-between">
                        <span className="text-sm text-body sm:text-center">© 2023 <a href="https://flowbite.com/" className="hover:underline">LocalHost™</a>. All Rights Reserved.
                        </span>
